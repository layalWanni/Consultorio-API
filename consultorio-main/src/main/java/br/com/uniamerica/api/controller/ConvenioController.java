...
public class ConvenioController {
    ...
    public ResponseEntity<?> update(@PathVariable Long idConvenio, @RequestBody Convenio convenio) {
        try {
    ...
    public ResponseEntity<?> desativar(@PathVariable Long idConvenio, @RequestBody Convenio convenio) {
        try {
